...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        description=
        "Attention based model for solving the Travelling Salesman Problem with Reinforcement Learning"
    )
    ...
    parser.add_argument(
        ...
        default=1.0,
        help=
        'Maximum L2 norm for gradient clipping, default 1.0 (0 to disable clipping)'
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'Number of epochs to warmup the baseline, default None means 1 for rollout (exponential '
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'Shrink the batch size if at least this many instances in the batch are finished'
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'Data distribution to use during training, defaults and options depend on problem.'
    )
    ...
    parser.add_argument(
        ...
        default=1,
        help=
        'Save checkpoint every n epochs (default 1), 0 to save no checkpoints')
    parser.add_argument(
        '--load_path',
