...
def run_alg(points, tmax, return_sol=False, verbose=True):
    ...
    for i in range(popsize + elitismn):
        ...
        chrom = (fitness(chrom, cpoints, start_point, end_point,
                         tmax)[0], chrom)
    ...
    for i in range(genlimit):
        ...
        for j in range(popsize):
            ...
            offspring = mutate(crossover(parents[0][1], parents[1][1]),
                               mchance, msigma)
            offspring = (fitness(offspring, cpoints, start_point, end_point,
                                 tmax)[0], offspring)
    ...
    total_distance = (
        oph.distance(start_point, cpoints[best_path[1][3] - 2]) +
